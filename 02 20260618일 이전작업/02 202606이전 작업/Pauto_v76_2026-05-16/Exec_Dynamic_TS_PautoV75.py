...
class Exec_Dynamic_TS_PautoV75:
    def __init__(self):
        pass
        ...
        if pos == "LONG":
            ...
            # [Phase 2] 계단식 파동 피보나치 (OB 소멸 및 가격 발견 구역)
                ...
                if roe >= fib_trigger or max_roe >= fib_trigger:
                    ...
                    bot_state['fib_stop'] = max(bot_state.get('fib_stop', 0), fib_lock)
        ...
        # ------------------------------------------------------------
            ...
            # [Phase 2] 계단식 파동 피보나치 (OB 소멸 및 가격 발견 구역)
                ...
                if roe >= fib_trigger or max_roe >= fib_trigger:
                    ...
                    bot_state['fib_stop'] = min(bot_state.get('fib_stop', float('inf')), fib_lock)
