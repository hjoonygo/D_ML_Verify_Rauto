# -*- coding: utf-8 -*-
# [파일명] check_07Prj_Ch4_RunAWS_Stg10_OverlapCapSweep.py — §4 check 3역할
...
STG = "07Prj_Ch4_RunAWS_Stg10_OverlapCapSweep"
CAUSAL_SHA = "c4964c5566af96311059172c59ffc17d4f374ebd608f5b30b409b8fbf122b4b9"
...
def main():
    ...
    tr = os.path.join(HERE, "stg10_result.txt")
