# -*- coding: utf-8 -*-
# [파일명] check_07Prj_Ch4_RunAWS_Stg12_SWERDampOnly.py — §4 check 3역할
...
STG = "07Prj_Ch4_RunAWS_Stg12_SWERDampOnly"
HASHES = {
...
def main():
    ...
    for rel, want in HASHES.items():
        ...
        checks.append((f"{os.path.basename(rel)}(§8)", got == want, got[:16]))
    ...
    tr = os.path.join(HERE, "stg12_result.txt")
