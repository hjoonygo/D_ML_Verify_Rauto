# -*- coding: utf-8 -*-
# [파일명] check_05Prj_Ch1_Stg4_SidewayDCA_AlphaUp.py
# 코드길이: 약 165줄 | 내부버전: SidewayDCA_AlphaUp_05_Ch1_Stg4 | 로직 전체 출력
...
VER = "SidewayDCA_AlphaUp_05_Ch1_Stg4"
TESTPY = "test_05Prj_Ch1_Stg4_SidewayDCA_AlphaUp.py"
CHECKPY = "check_05Prj_Ch1_Stg4_SidewayDCA_AlphaUp.py"
...
def check_all():
    ...
    # 10. stg4 정밀필터 작동 증빙 — summary에 FILTER 행이 있고 차단건수가 기록됐는지
